...
# data_add поменять на дату транзакции
# pk установить автоинкриментным
# добавить поле description
# is income заменить на тип
# добавить категорию баланс которая не будет удаляться
# добавить поле id_transactions
# добавить поле валюты
